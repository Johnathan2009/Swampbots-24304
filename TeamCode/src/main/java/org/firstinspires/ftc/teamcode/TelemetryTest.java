...
public class TelemetryTest extends LinearOpMode {  //The class of the code.  Extends LinearOpMode, making it a subclass
    ...
    DcMotor slideMotor = null;  //Declares arm lift motor and sets it to null
    ...
    public void runOpMode() {  //the main method that is called when you run the code
        ...
        slideMotor = hardwareMap.dcMotor.get("slideMotor");  //Declares arm slide motor
        ...
        while(opModeIsActive()) {  //runs while code is running
            ...
            telemetry.addData("LiftPos:", slideMotor.getCurrentPosition());  //displays the position of the arm slide motor
